...
humanoid-profile-editor-pronouns-female-text = Elle / Elle
humanoid-profile-editor-pronouns-epicene-text = Iel / Ellui
...
humanoid-profile-editor-preference-unavailable-spawn-as-overflow-button =  Être {FR_INDEFINITE($overflowJob)} {$overflowJob} si mes préférences ne sont pas disponibles.
