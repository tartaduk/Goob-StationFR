...
lock-comp-generic-fail = {CAPITALIZE(SUBJECT($target))} {CONJUGATE-BE($target)} verrouillé(e).

## ToggleLockVerb

toggle-lock-verb-unlock = Verrouiller
toggle-lock-verb-lock = Déverrouiller
