...
shell-entity-with-uid-lacks-component = L'entité avec l'UID {$uid} n'a pas de composant {FR_INDEFINITE($componentName)} {$componentName}
shell-entity-target-lacks-component = L'entité cible n'a pas de composant {FR_INDEFINITE($componentName)} {$componentName}
shell-invalid-color-hex = Code couleur hexadécimal invalide !
shell-target-player-does-not-exist = Le joueur cible n'existe pas !
shell-target-entity-does-not-have-message = L'entité cible n'a pas de {FR_INDEFINITE($missing)} {$missing} !
